...
//                     <img src="xkld.jpg" className="w-full h-auto" />
    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình xuất khẩu lao động Đài Loan tại Trung tâm BlueOcean
            </h2>

            <p className="text-justify italic">
              Trung tâm Ngoại ngữ Quốc tế BlueOcean tự hào là đơn vị uy tín, đồng hành cùng bạn trong hành trình xuất khẩu lao động Đài Loan – cơ hội việc làm hấp dẫn với mức thu nhập tốt và môi trường làm việc chuyên nghiệp.
            </p>

            <p className="text-justify">
              Những điểm nổi bật của chương trình xuất khẩu lao động Đài Loan tại BlueOcean:
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Tư vấn chuyên nghiệp và miễn phí:</strong> Hướng dẫn chi tiết thủ tục hồ sơ, chuẩn bị kỹ năng và ngôn ngữ để sẵn sàng làm việc tại Đài Loan.
              </li>
              <li>
                <strong>Đào tạo tiếng Trung bài bản:</strong> Lộ trình học cá nhân hóa, giúp bạn giao tiếp hiệu quả, thích nghi nhanh với môi trường mới.
              </li>
              <li>
                <strong>Đối tác uy tín tại Đài Loan:</strong> Kết nối với các công ty tuyển dụng hàng đầu, đảm bảo việc làm ổn định và minh bạch.
              </li>
              <li>
                <strong>Hỗ trợ toàn diện:</strong> Từ chuẩn bị hồ sơ, phỏng vấn đến khi làm việc, BlueOcean luôn sát cánh cùng bạn.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="xkld.jpg"
              alt="Đài Loan - Taipei 101"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://cdn.pixabay.com/photo/2018/02/26/20/44/worker-3182366_1280.jpg"
              alt="Lao động tại Đài Loan"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
