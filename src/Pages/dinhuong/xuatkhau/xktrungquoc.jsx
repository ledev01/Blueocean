    ...
    <div className="pb-[100px]">
      ...
      <div className="relative">
        <img
          src="https://png.pngtree.com/thumb_back/fw800/back_our/20190621/ourmid/pngtree-e-commerce-book-knowledge-teacher-education-banner-background-image_186718.jpg"
          className="w-full h-72 object-cover"
          alt="Banner xuất khẩu lao động Trung Quốc"
        />
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="flex text-white font-semibold text-sm drop-shadow-md">
            <a href="/" className="breadcrumb-arrow-left bg-gray-400 px-4 py-2 rounded-l-md">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình xuất khẩu lao động Trung Quốc tại BlueOcean
            </h2>

            <p className="text-justify italic">
              Trung Quốc là thị trường lao động lớn, với nhiều ngành nghề đa dạng, từ sản xuất đến xây dựng, mang lại nhiều cơ hội việc làm và trải nghiệm văn hóa phong phú.
            </p>

            <p className="text-justify">
              BlueOcean đồng hành cùng bạn qua quá trình chuẩn bị hồ sơ, đào tạo tiếng Trung cơ bản và hỗ trợ định hướng kỹ năng cần thiết trước khi xuất cảnh.
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Đào tạo tiếng Trung bài bản:</strong> Giúp người lao động tự tin giao tiếp và làm việc hiệu quả.
              </li>
              <li>
                <strong>Hỗ trợ thủ tục pháp lý:</strong> Tư vấn visa, hợp đồng, bảo hiểm, đảm bảo quyền lợi của người lao động.
              </li>
              <li>
                <strong>Đối tác uy tín tại Trung Quốc:</strong> Cam kết việc làm rõ ràng, môi trường làm việc an toàn.
              </li>
              <li>
                <strong>Hỗ trợ sau khi sang Trung Quốc:</strong> Giúp đỡ về chỗ ở, liên lạc và giải quyết các vấn đề phát sinh.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="xkld.jpg"
              alt="Xuất khẩu lao động Trung Quốc"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://cdn.pixabay.com/photo/2016/11/29/05/08/china-1869762_1280.jpg"
              alt="Thành phố Trung Quốc"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
