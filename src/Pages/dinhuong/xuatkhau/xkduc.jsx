    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình xuất khẩu lao động Đức tại Trung tâm BlueOcean
            </h2>

            <p className="text-justify italic">
              Đức là một trong những thị trường lao động hấp dẫn nhất với mức thu nhập cao, môi trường làm việc chuyên nghiệp và nhiều cơ hội phát triển.
            </p>

            <p className="text-justify">
              Trung tâm Ngoại ngữ Quốc tế BlueOcean tự hào đồng hành cùng bạn với chương trình xuất khẩu lao động Đức bài bản, giúp bạn chuẩn bị tốt nhất từ kỹ năng, ngoại ngữ đến thủ tục hồ sơ.
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Đào tạo tiếng Đức chuyên sâu:</strong> Giúp bạn làm quen với ngôn ngữ và văn hóa Đức để thích nghi nhanh chóng.
              </li>
              <li>
                <strong>Tư vấn và hỗ trợ hồ sơ:</strong> Hướng dẫn từng bước chuẩn bị hồ sơ xin việc, visa và giấy tờ cần thiết.
              </li>
              <li>
                <strong>Đối tác uy tín tại Đức:</strong> Kết nối với các doanh nghiệp hàng đầu, đảm bảo việc làm ổn định và minh bạch.
              </li>
              <li>
                <strong>Hỗ trợ trong suốt quá trình làm việc:</strong> BlueOcean luôn đồng hành để bạn yên tâm công tác tại Đức.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="xkld.jpg"
              alt="Thành phố Munich, Đức"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://cdn.pixabay.com/photo/2016/03/26/13/09/worker-1282349_1280.jpg"
              alt="Lao động làm việc tại Đức"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
