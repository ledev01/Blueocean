    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình xuất khẩu lao động Hàn Quốc tại BlueOcean
            </h2>

            <p className="text-justify italic">
              Hàn Quốc là thị trường lao động hấp dẫn với mức thu nhập tốt, môi trường làm việc chuyên nghiệp và nhiều cơ hội phát triển kỹ năng.
            </p>

            <p className="text-justify">
              BlueOcean hỗ trợ học viên từ A đến Z với chương trình đào tạo tiếng Hàn bài bản, tư vấn thủ tục nhanh chóng và hợp tác với các doanh nghiệp uy tín tại Hàn Quốc.
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Đào tạo tiếng Hàn chuẩn:</strong> Giúp bạn tự tin giao tiếp và hòa nhập môi trường làm việc.
              </li>
              <li>
                <strong>Tư vấn hồ sơ và thủ tục:</strong> Hướng dẫn chi tiết các bước chuẩn bị giấy tờ, phỏng vấn và xin visa.
              </li>
              <li>
                <strong>Đối tác tuyển dụng uy tín:</strong> Kết nối với các nhà máy, xí nghiệp hàng đầu tại Hàn Quốc.
              </li>
              <li>
                <strong>Hỗ trợ toàn diện:</strong> Theo sát và hỗ trợ học viên trong suốt quá trình xuất cảnh và làm việc tại Hàn Quốc.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="xkld.jpg"
              alt="Công nhân làm việc tại Hàn Quốc"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Lotte_Tower_Seoul_2018.jpg/1280px-Lotte_Tower_Seoul_2018.jpg"
              alt="Thành phố Seoul, Hàn Quốc"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
