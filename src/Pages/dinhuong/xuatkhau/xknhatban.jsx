    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình xuất khẩu lao động Nhật Bản tại BlueOcean
            </h2>

            <p className="text-justify italic">
              Nhật Bản là thị trường lao động tiềm năng với mức lương hấp dẫn, môi trường làm việc an toàn và nhiều cơ hội phát triển bản thân.
            </p>

            <p className="text-justify">
              BlueOcean cung cấp chương trình đào tạo tiếng Nhật chất lượng, hỗ trợ hồ sơ và tư vấn phỏng vấn, giúp bạn sẵn sàng bước vào môi trường làm việc tại Nhật.
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Đào tạo tiếng Nhật chuyên sâu:</strong> Giúp bạn thành thạo giao tiếp và kỹ năng cần thiết.
              </li>
              <li>
                <strong>Hỗ trợ hoàn thiện hồ sơ:</strong> Tư vấn thủ tục pháp lý, visa, hợp đồng lao động đầy đủ.
              </li>
              <li>
                <strong>Đối tác Nhật Bản uy tín:</strong> Liên kết với các doanh nghiệp có nhu cầu tuyển dụng lớn.
              </li>
              <li>
                <strong>Hỗ trợ học viên sau xuất cảnh:</strong> Đồng hành trong suốt quá trình làm việc và sinh hoạt tại Nhật Bản.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="xkld.jpg"
              alt="Lao động tại Nhật Bản"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://upload.wikimedia.org/wikipedia/commons/5/59/Osaka_night_view.jpg"
              alt="Thành phố Osaka, Nhật Bản"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
