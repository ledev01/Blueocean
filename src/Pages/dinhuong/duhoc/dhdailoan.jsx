    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình Du học Đài Loan tại Blue Ocean
            </h2>


           <p className="text-justify italic">
              Du học Đài Loan ngày càng thu hút nhiều bạn trẻ nhờ chất lượng giáo dục tốt, chi phí hợp lý và cơ hội học tập, làm việc hấp dẫn. Nhiều trung tâm tư vấn du học uy tín đã triển khai các chương trình phù hợp với nhu cầu của học sinh, sinh viên Việt Nam.
            </p>

            <p className="text-justify">
              Các chương trình du học Đài Loan tại Blue Ocean
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Học tiếng Trung ngắn hạn:</strong> Thời gian 6 tháng đến 1 năm giúp làm quen với ngôn ngữ và văn hóa.
              </li>
              <li>
                <strong>Chương trình đại học chính quy:</strong> Học nhiều ngành đa dạng với bằng cấp được công nhận quốc tế.
              </li>
              <li>
                <strong>Chương trình sau đại học:</strong> Thạc sĩ, tiến sĩ nâng cao chuyên môn và nghiên cứu.
              </li>
              <li>
                <strong>Thực tập và làm việc:</strong> Cơ hội vừa học vừa thực tập tại doanh nghiệp Đài Loan.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            ...
            />
            {/* <img
              src="https://media.taiwan.net.tw/webpub/2020/02/1.jpg"
              alt="Sinh viên du học Đài Loan"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
