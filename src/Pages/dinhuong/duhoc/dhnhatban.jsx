...
//                     <img src="dhnb.webp" className="w-full h-auto" />
    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Chương trình Du học Nhật Bản tại Blue Ocean
            </h2>

            <p className="text-justify italic">
              Du học Nhật Bản là lựa chọn hấp dẫn cho nhiều sinh viên Việt Nam nhờ nền giáo dục tiên tiến, môi trường học tập an toàn và nhiều cơ hội làm thêm cũng như phát triển nghề nghiệp.
            </p>

            <p className="text-justify">
              Các chương trình du học Nhật Bản phổ biến hiện nay bao gồm:
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Học tiếng Nhật ngắn hạn:</strong> Khóa học từ 6 tháng đến 1 năm giúp sinh viên làm quen với ngôn ngữ và văn hóa Nhật Bản.
              </li>
              <li>
                <strong>Chương trình học đại học chính quy:</strong> Nhiều ngành đa dạng như kỹ thuật, kinh tế, công nghệ thông tin, y tế với bằng cấp quốc tế.
              </li>
              <li>
                <strong>Chương trình sau đại học (thạc sĩ, tiến sĩ):</strong> Cơ hội nghiên cứu chuyên sâu và phát triển nghề nghiệp tại Nhật.
              </li>
              <li>
                <strong>Chương trình kỹ năng đặc định và thực tập kỹ thuật:</strong> Cung cấp cơ hội làm việc tại Nhật với visa đặc biệt.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            ...
            />
            {/* <img
              src="https://upload.wikimedia.org/wikipedia/commons/4/48/Nihonbashi_Chuo-ku_Tokyo_Japan.jpg"
              alt="Cuộc sống tại Nhật Bản"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
