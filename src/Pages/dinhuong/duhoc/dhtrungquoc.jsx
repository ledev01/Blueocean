...
//                     <img src="dhtq.jpg" className="w-full h-auto" />
    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Du học Trung Quốc – Cơ hội và lợi thế
            </h2>

            <p className="text-justify italic">
              Trung Quốc là điểm đến du học hấp dẫn với nền giáo dục phát triển, chi phí học tập hợp lý và nhiều chương trình học đa dạng. Đây là cơ hội lớn cho sinh viên mở rộng tầm nhìn và trải nghiệm văn hóa phong phú.
            </p>

            <p className="text-justify">
              Những lợi thế khi du học tại Trung Quốc bao gồm:
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Chất lượng giáo dục:</strong> Nhiều trường đại học hàng đầu thế giới với chương trình giảng dạy đa dạng từ đại học đến sau đại học.
              </li>
              <li>
                <strong>Học phí và chi phí sinh hoạt:</strong> Thấp hơn nhiều so với các nước phát triển, phù hợp với đa số sinh viên Việt Nam.
              </li>
              <li>
                <strong>Học bổng hấp dẫn:</strong> Chính phủ Trung Quốc và các trường đại học thường xuyên có các suất học bổng toàn phần hoặc bán phần.
              </li>
              <li>
                <strong>Cơ hội nghề nghiệp:</strong> Nền kinh tế lớn mạnh mở ra nhiều cơ hội việc làm cho sinh viên tốt nghiệp.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            ...
            />
            {/* <img
              src="https://upload.wikimedia.org/wikipedia/commons/8/88/Tsinghua_University_Main_Gate.jpg"
              alt="Cổng trường Đại học Thanh Hoa"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
