...
//                     <img src="dhd.pn" className="w-full h-auto" />
    ...
    <div className="pb-[100px]">
      ...
      <div className="max-w-[1000px] mx-auto px-4 mt-10">
        <div className="grid md:grid-cols-2 gap-x-10 gap-y-8">
          ...
          <div className="flex flex-col gap-y-6 leading-relaxed text-[15px] text-gray-800">
            <h2 className="text-xl font-bold text-blue-600 italic">
              Du học Đức – Cơ hội phát triển toàn diện
            </h2>

            <p className="text-justify italic">
              Đức nổi tiếng với nền giáo dục chất lượng cao, đặc biệt là đào tạo kỹ thuật và khoa học, cùng môi trường học tập hiện đại và đa văn hóa. Học tập tại Đức là lựa chọn sáng suốt cho sinh viên quốc tế.
            </p>

            <p className="text-justify">
              Những điểm mạnh khi du học Đức:
            </p>

            <ul className="list-disc pl-5 space-y-2 text-justify">
              <li>
                <strong>Học phí thấp hoặc miễn phí:</strong> Hầu hết các trường công lập đều có học phí rất thấp hoặc miễn phí cho sinh viên quốc tế.
              </li>
              <li>
                <strong>Chương trình đào tạo đa dạng:</strong> Từ kỹ thuật, kinh tế đến nghệ thuật và khoa học xã hội.
              </li>
              <li>
                <strong>Môi trường học tập quốc tế:</strong> Cơ hội giao lưu văn hóa và nâng cao ngoại ngữ trong môi trường đa quốc gia.
              </li>
              <li>
                <strong>Cơ hội thực tập và việc làm:</strong> Đức có nhiều chương trình thực tập và cơ hội việc làm cho sinh viên sau tốt nghiệp.
              </li>
            </ul>
          ...
          <div className="flex flex-col gap-y-6">
            <img
              src="dhd.jpg"
              alt="Đại học Kỹ thuật München"
              className="w-full rounded-lg shadow-md"
            />
            {/* <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Berlin_Skyline_Fernsehturm_2018.jpg/1280px-Berlin_Skyline_Fernsehturm_2018.jpg"
              alt="Thành phố Berlin"
              className="w-full rounded-lg shadow-md"
            /> */}
          </div>
        </div>
